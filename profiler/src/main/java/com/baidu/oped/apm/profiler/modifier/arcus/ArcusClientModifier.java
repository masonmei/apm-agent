...
public class ArcusClientModifier extends AbstractModifier {
    ...
    public byte[] modify(ClassLoader classLoader, String javassistClassName,
        ...
        try {
            ...
            final Interceptor setCacheManagerInterceptor = byteCodeInstrumentor.newInterceptor(classLoader,protectedDomain,"com.baidu.oped.apm.profiler.modifier.arcus.interceptor.SetCacheManagerInterceptor");
            ...
            for (MethodInfo method : declaredMethods) {
                ...
                SimpleAroundInterceptor apiInterceptor = (SimpleAroundInterceptor) byteCodeInstrumentor.newInterceptor(classLoader, protectedDomain,
                                "com.baidu.oped.apm.profiler.modifier.arcus.interceptor.ApiInterceptor");
