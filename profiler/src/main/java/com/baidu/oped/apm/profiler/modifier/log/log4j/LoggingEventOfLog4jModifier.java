 ...
 */
package com.baidu.oped.apm.profiler.modifier.log.log4j;
...
public class LoggingEventOfLog4jModifier extends AbstractModifier {
    ...
    public byte[] modify(ClassLoader classLoader, String javassistClassName, ProtectionDomain protectedDomain, byte[] classFileBuffer) {
        ...
        try {
            ...
            Interceptor interceptor1 = byteCodeInstrumentor.newInterceptor(classLoader, protectedDomain, "com.baidu.oped.apm.profiler.modifier.log.log4j.interceptor.LoggingEventOfLog4jInterceptor");
            ...
            Interceptor interceptor2 = byteCodeInstrumentor.newInterceptor(classLoader, protectedDomain, "com.baidu.oped.apm.profiler.modifier.log.log4j.interceptor.LoggingEventOfLog4jInterceptor");
            ...
            Interceptor interceptor3 = byteCodeInstrumentor.newInterceptor(classLoader, protectedDomain, "com.baidu.oped.apm.profiler.modifier.log.log4j.interceptor.LoggingEventOfLog4jInterceptor");
